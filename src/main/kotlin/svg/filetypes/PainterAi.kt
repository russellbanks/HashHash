...
brush = SolidColor(Color(255, 117, 27, 255))
...
shape = Outline.Generic(generalPath!!)
brush = SolidColor(Color(255, 151, 82, 255))
drawOutline(outline = shape!!, style=Fill, brush=brush!!, alpha=alpha, blendMode = blendMode)
alpha = alphaStack.removeAt(0)
blendMode = blendModeStack.removeAt(0)
alphaStack.add(0, alpha)
...
generalPathText?.run {
    moveTo(279.9727f, 402.0f)
    lineTo(256.05536f, 402.0f)
    lineTo(248.34866f, 378.3927f)
    lineTo(210.92249f, 378.3927f)
    lineTo(203.34866f, 402.0f)
    lineTo(179.56421f, 402.0f)
    lineTo(217.25615f, 299.06693f)
    lineTo(243.0337f, 299.06693f)
    lineTo(279.9727f, 402.0f)
    close()
    moveTo(243.16658f, 361.47342f)
    lineTo(231.47366f, 325.7746f)
    quadraticBezierTo(230.3221f, 322.40845f, 229.87918f, 316.82776f)
    lineTo(229.2591f, 316.82776f)
    quadraticBezierTo(228.86047f, 321.34546f, 227.48744f, 325.50885f)
    lineTo(215.70595f, 361.47342f)
    lineTo(243.16658f, 361.47342f)
    close()
    moveTo(314.82996f, 299.06693f)
    lineTo(314.82996f, 402.0f)
    lineTo(292.90573f, 402.0f)
    lineTo(292.90573f, 299.06693f)
    lineTo(314.82996f, 299.06693f)
    close()
}
