...
generalPathText?.run {
    moveTo(231.34079f, 402.0f)
    lineTo(207.42346f, 402.0f)
    lineTo(199.71677f, 378.3927f)
    lineTo(162.29059f, 378.3927f)
    lineTo(154.71677f, 402.0f)
    lineTo(130.93231f, 402.0f)
    lineTo(168.62425f, 299.06693f)
    lineTo(194.40181f, 299.06693f)
    lineTo(231.34079f, 402.0f)
    close()
    moveTo(194.53468f, 361.47342f)
    lineTo(182.84177f, 325.7746f)
    quadraticBezierTo(181.6902f, 322.40845f, 181.24728f, 316.82776f)
    lineTo(180.6272f, 316.82776f)
    quadraticBezierTo(180.22858f, 321.34546f, 178.85555f, 325.50885f)
    lineTo(167.07405f, 361.47342f)
    lineTo(194.53468f, 361.47342f)
    close()
    moveTo(329.0032f, 299.06693f)
    lineTo(293.2601f, 402.0f)
    lineTo(268.45694f, 402.0f)
    lineTo(233.20103f, 299.06693f)
    lineTo(256.8526f, 299.06693f)
    lineTo(279.08685f, 371.8376f)
    quadraticBezierTo(280.76993f, 377.19684f, 281.16855f, 381.98032f)
    lineTo(281.56717f, 381.98032f)
    quadraticBezierTo(282.09866f, 377.06396f, 283.82602f, 371.57184f)
    lineTo(306.06027f, 299.06693f)
    lineTo(329.0032f, 299.06693f)
    close()
    moveTo(363.46185f, 299.06693f)
    lineTo(363.46185f, 402.0f)
    lineTo(341.53763f, 402.0f)
    lineTo(341.53763f, 299.06693f)
    lineTo(363.46185f, 299.06693f)
    close()
}
