...
generalPathText?.run {
    ...
    close()
    moveTo(393.18137f, 299.06693f)
    lineTo(393.18137f, 364.44095f)
    lineTo(407.70892f, 364.44095f)
    lineTo(407.70892f, 380.07578f)
    lineTo(393.18137f, 380.07578f)
    lineTo(393.18137f, 402.0f)
    lineTo(373.6489f, 402.0f)
    lineTo(373.6489f, 380.07578f)
    lineTo(327.67447f, 380.07578f)
    lineTo(327.67447f, 364.30807f)
    quadraticBezierTo(341.93628f, 348.3632f, 354.42645f, 330.55807f)
    quadraticBezierTo(366.9166f, 312.75296f, 373.29456f, 299.06693f)
    lineTo(393.18137f, 299.06693f)
    close()
    moveTo(346.67545f, 364.44095f)
    lineTo(373.6489f, 364.44095f)
    lineTo(373.6489f, 326.7047f)
    quadraticBezierTo(370.4599f, 332.68405f, 364.48056f, 341.188f)
    quadraticBezierTo(358.54553f, 349.69193f, 346.67545f, 364.44095f)
    close()
}
